...
export default function Sidebar({
  open,
  doc, uploading, uploadError, onUpload, onChangeDoc,
  ...
  return (
    ...
    >
      ...
      <div className="px-3 py-3 border-b border-border flex-shrink-0">
        {doc ? (
          <div className="flex items-center gap-2 bg-accent-faint border border-accent/20 rounded-lg px-3 py-2">
            ...
            <button
              onClick={onChangeDoc}
              className="text-text-muted hover:text-text-primary transition-colors text-base leading-none flex-shrink-0"
        ...
        {uploadError && (
          <p className="mt-2 text-xs text-red-400 bg-red-400/10 border border-red-400/20 rounded-md px-2.5 py-1.5">
            {uploadError}
          </p>
        )}
      </div>
            ...
            >
              ...
              <button
                ...
                className="
                  ...
                  text-base leading-none px-1 rounded transition-all
                "
                title="Delete"
              >
                ×
      ...
      {user && (
        <div className="flex items-center gap-2.5 px-3 py-3 border-t border-border flex-shrink-0">
          ...
          <button
            onClick={onLogOut}
            className="
              flex-shrink-0 text-[11px] text-text-muted
